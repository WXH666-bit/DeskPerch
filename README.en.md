...
PRO X Wireless may report an abrupt percentage drop after a restart while charging. The widget shows “电量待确认” (battery reading pending confirmation) for this anomaly while retaining a confirmed charging indication. The alert does not claim a matching change in actual battery capacity.
